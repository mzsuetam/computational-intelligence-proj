...
# %%
loss_weights = torch.tensor([1.0, 1.0, 1.0, 1.0, 2.0, 1.2]) # slightly favor small classes
...
learn_cse.load('best_segmentation', weights_only=True)
...
learn_cse.fit_one_cycle(
    ...
    cbs=[
        SaveCB('cse_phase_4_2_combined_loss'),
        LogCB('cse_phase_4_2_combined_loss_log.csv'),
